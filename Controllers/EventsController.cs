...
namespace ASP_Ticket_Center.Controllers
{
    public class EventsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Events.Include(@ => @.Categories);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CategoryId,Location,Description,ImageURL,Organizer,Capacity,Date,MaxPrice,MinPrice,Status,Last_Update")] Event @event)
        {
